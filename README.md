...
| --- | --- |
| [enterprise-rag-evaluation-platform](https://github.com/AmitChoudhary123/enterprise-rag-evaluation-platform) | Production RAG pattern with retrieval, citations, grounding, and release-gate thinking. |
...
Python, FastAPI, Pydantic, pandas, scikit-learn, YAML-driven workflows, RAG evaluation patterns, agent workflow design, MLOps concepts, GitHub Actions, and enterprise architecture documentation.
